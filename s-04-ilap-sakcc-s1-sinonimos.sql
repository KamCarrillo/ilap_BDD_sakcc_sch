...
create or replace synonym sucursal_f3 for sucursal_f3_sakcc_s1;
...
-- SUCURSAL_VENTA
-------------------------------------------------------------------------------
create or replace synonym sucursal_venta_f3 for sucursal_venta_f3_sakcc_s1;
...
-- SUCURSAL_TALLER
-------------------------------------------------------------------------------
create or replace synonym sucursal_taller_f3 for sucursal_taller_f3_sakcc_s1;
...
-------------------------------------------------------------------------------
create or replace synonym laptop_f3 for laptop_f3_sakcc_s1;
...
create or replace synonym historico_status_laptop_f2 for historico_status_laptop_f2_sch_s2@schbdd_s2.fi.unam;

-------------------------------------------------------------------------------
-- SERVICIO_LAPTOP (derivada por sucursal, 4 fragmentos)
-------------------------------------------------------------------------------
create or replace synonym servicio_laptop_f3 for servicio_laptop_f3_sakcc_s1;
...
-- tipo_procesador
create or replace synonym tipo_procesador_r1 for tipo_procesador_r_sch_s1@schbdd_s1.fi.unam;
create or replace synonym tipo_procesador_r2 for tipo_procesador_r_sch_s2@schbdd_s2.fi.unam;
create or replace synonym tipo_procesador_r3 for tipo_procesador_r_sakcc_s1;
...
-- tipo_almacenamiento
create or replace synonym tipo_almacenamiento_r1 for tipo_almacenamiento_r_sch_s1@schbdd_s1.fi.unam;
...
-- tipo_monitor
create or replace synonym tipo_monitor_r3 for tipo_monitor_r_sakcc_s1;
create or replace synonym tipo_monitor_r1 for tipo_monitor_r_sch_s1@schbdd_s1.fi.unam;

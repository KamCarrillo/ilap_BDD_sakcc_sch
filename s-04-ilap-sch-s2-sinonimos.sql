...
create or replace synonym sucursal_f2 for sucursal_f2_sch_s2;
...
create or replace synonym sucursal_venta_f2 for sucursal_venta_f2_sch_s2;
...
create or replace synonym sucursal_taller_f2 for sucursal_taller_f2_sch_s2;
...
create or replace synonym laptop_f2 for laptop_f2_sch_s2;
...
-- tipo_procesador
create or replace synonym tipo_procesador_r1 for tipo_procesador_r_sch_s2;
...
-- tipo_tarjeta_video
create or replace synonym tipo_tarjeta_video_r1 for tipo_tarjeta_video_r_sch_s2;
...
-- tipo_almacenamiento
create or replace synonym tipo_almacenamiento_r1 for tipo_almacenamiento_r_sch_s2;
...
-- tipo_monitor
create or replace synonym tipo_monitor_r1 for tipo_monitor_r_sch_s2;
